...
<div class="body-container" style="padding: 0;">
    <div class="product-section">
        <div class="title">
            <p class="text-center text-64 font-medium">{{ $product_type->name }}</p>
        </div>
                ...
                @if ($images_3[0] != '') 
                    <div class="flex-row" style="justify-content: space-between; align-items: center; width: 100%;">
                        @foreach ($images_3 as $img)
                            <img src="{{ asset($img) }}" alt="Product" height="72">
                        @endforeach
                    </div>
                @endif
            </a>
                ...
                <div class="modal-dialog modal-dialog-centered modal-stable">
                    <div class="modal-content" style="width: 100%; padding: 0; gap: 0;">
                        ...
                        <div style="padding: 100px; width: 100%;">
                            <p class="text-80 font-bold color-primary-500" style="margin-bottom: 24px;">{{$category->name}}</p>
                            <div class="text-40 color-black" style="max-width: 1362px; line-height: 130%;">{!! $category->description !!}</div>
                        </div>
                        <div style="padding: 100px; background: var(--color-gray-200);  width: 100%;">
    ...
    <div>
        <div class="py-40px" style="margin-top: 40px;">
            <p class="text-center text-64 font-medium">Other Products</p>
        </div>
